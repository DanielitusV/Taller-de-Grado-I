...
\begin{longtable}{|p{0.20\textwidth}|p{0.25\textwidth}|p{0.16\textwidth}|p{0.18\textwidth}|p{0.08\textwidth}|}
\hline
...
Bibliografía, casos de amenaza y guías de ciberseguridad. &
...
Referentes de juegos serios, prototipos de interfaz y motor de desarrollo. &
...
Marco teórico, contenidos de seguridad y criterios pedagógicos. &
...
Ejemplos de incidentes, patrones de ataque y documentación técnica. &
...
Registros del juego, criterios de evaluación y diseño de interfaz. &
...
Usuarios de prueba, cuestionario y prototipo funcional. &
